function [q,qd,qdd,trajTimes] = compute_trajectory_mod(weights,jointInit,T0,TF, robot, endEffector, trajDuration)
...
%   https://www.mathworks.com/help/robotics/referencelist.html?type=function&category=manipulators
        ...
        [T, ~, ~] = transformtraj(T0,TF,timeInterval,trajTimes, 'TimeScaling',[s;sd;sdd]/timeInterval(end));
